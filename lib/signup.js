...
exports.checkinVolunteer = function(volunteerID, callback){
	
	exports.Volunteer.findOne({_id : volunteerID.toObjectId()}, function(err, volunteer){
		if(err || (volunteer == null)){
			console.log('ERROR: can\'t checkin in volunteer with ID: '+volunteerID);
			return false;
		}
	});
